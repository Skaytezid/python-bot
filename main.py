...
BOT_TOKEN = "7254981239:AAH1e1qImkLcKXVCck5YlfwwJ-9zGQsjtFo"
PAYMENT_CHANNEL = "@tonpayup" #add payment channel here including the '@' sign
OWNER_ID = 6059164255 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@airdropexo"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
